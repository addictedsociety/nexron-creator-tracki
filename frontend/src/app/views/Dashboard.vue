...
import TimeCard from '@/app/views/dashboard/components/timercard.vue'
import WeightCard from '@/app/views/dashboard/components/weightcard.vue'
import Daychecker from '@/app/views/dashboard/components/daychecker.vue'
