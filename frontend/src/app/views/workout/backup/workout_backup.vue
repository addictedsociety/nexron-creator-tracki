            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2" v-if="newExerciseForm.category">
                ...
                <Select v-model="newExerciseForm.name">
                  ...
                  <SelectContent>
                    <SelectItem v-for="exercise in exerciseLibrary[newExerciseForm.category]" :key="exercise"
                      :value="exercise">
                      {{ exercise }}
                    </SelectItem>
                  </SelectContent>
          ...
          <div class="space-y-3">
            <Card v-for="exercise in currentWorkout.exercises" :key="exercise.id" class="border">
              ...
              <CardContent class="space-y-2">
                <div class="space-y-1">
                  <div v-for="(set, index) in exercise.sets" :key="set.id"
                    ...
                    <Input v-model.number="set.weight" type="number" step="0.5" class="w-20 h-8 text-sm"
                      placeholder="kg" />
                    <span class="text-sm text-muted-foreground">kg ×</span>
                    <Input v-model.number="set.reps" type="number" class="w-16 h-8 text-sm" placeholder="reps" />
                    <Button @click="toggleSetCompletion(exercise.id, set.id)"
                      :variant="set.completed ? 'default' : 'outline'" size="sm" class="ml-auto">
                      {{ set.completed ? '✓' : '○' }}
                    </Button>
                  </div>
                </div>
