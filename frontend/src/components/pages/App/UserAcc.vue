...
<template>
  <Dialog>
    ...
    <DialogTrigger as-child>
      <Button
        variant="ghost"
        class="w-12 h-12 sm:w-11 sm:h-11 grid place-items-center rounded-xl
               bg-secondary text-secondary-foreground
               hover:bg-accent hover:text-accent-foreground
               transition-all duration-200 snap-start p-0
               aria-[state=open]:ring-2 aria-[state=open]:ring-accent"
              ...
              <AlertDialog>
                <AlertDialogTrigger as-child>
                  <Button
                    size="lg"
                    variant="destructive"
                    class="w-full sm:w-auto h-12 sm:h-10"
                  >
                    Signout
                  </Button>
                </AlertDialogTrigger>

                <AlertDialogContent class="w-[92vw] max-w-[92vw] sm:max-w-[420px] rounded-none sm:rounded-lg">
                  <AlertDialogHeader>
                    <AlertDialogTitle class="text-base sm:text-lg">Bist du dir sicher?</AlertDialogTitle>
                  </AlertDialogHeader>
                  <AlertDialogFooter class="gap-2 sm:gap-0">
                    <AlertDialogCancel class="h-10 sm:h-9">Abbrechen</AlertDialogCancel>
                    <SignOutButton
                      class="h-10 sm:h-9 px-4 grid place-items-center rounded-md
                             bg-secondary text-secondary-foreground
                             hover:bg-accent hover:text-accent-foreground
